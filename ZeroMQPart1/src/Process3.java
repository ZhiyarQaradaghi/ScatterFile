    ...
    public static void main(String[] args) {
        ...
        try (ZContext context = new ZContext()) {
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                System.out.println("Process 3 received chunk: " + new String(receivedMessage.getFileContent()));
            }
            
            if (allChunksReceived) {
                    ZMQ.Socket ackFromM = context.createSocket(SocketType.SUB);
                    ackFromM.bind("tcp://*:8003");
                    ...
                    System.out.println("process 3: Received acknowledgement "+ new String(reply, ZMQ.CHARSET));
                    ...
                    sendSocketToMain.connect("tcp://localhost:7003");
            ...
            System.err.println("Process 3 error: " + ex.getMessage());
        }
    }
